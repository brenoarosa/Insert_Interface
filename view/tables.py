...
def tables (tables, db):
  ...
  print "<div><input type=\"radio\" name=\"DATABASE_ACTION\" value=\"ADVANCED\" >Advanced</div>"
  print "<div><input type=\"radio\" name=\"DATABASE_ACTION\" value=\"VALIDATION\" checked >Advanced - Validation >>Em teste! </div>"
